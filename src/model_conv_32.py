...
class ModelConv32(ModelBase):
    ...
    def decoder(self, z, reuse=False):
        with tf.variable_scope('decoder') as scope:
            ...
            c_i = bn_lrelu_tconv(c_i, 4, 2, self.batch_size, 16, self.bn_settings, name="dec_tconv_4")
            # Now c_i has shape batch_size x 32 x 32 x 16
    ...
    def gan(self, x_image, reuse=False, features=False):
        ...
        with tf.variable_scope('gan') as scope:
            ...
            c_i = bn_lrelu_conv(c_i, 4, 2, 32 * self.k, name="gan_conv_2")
            ...
            c_i = bn_lrelu_conv(c_i, 4, 4, 1, name="gan_conv_fin")
